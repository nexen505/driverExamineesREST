...
import com.komarmoss.messaging.model.service.SubscriberService;
...
public class SMTPMessageReceiver implements SessionAwareMessageListener<TextMessage> {
    ...
    public void onMessage(TextMessage textMessage, Session session) throws JMSException {
        ...
        try {
            ...
            final List<SubscriberEntity> subscribers = subscriberService.getSubscribers(msg.getType(), msg.getChangedEntityClass());
